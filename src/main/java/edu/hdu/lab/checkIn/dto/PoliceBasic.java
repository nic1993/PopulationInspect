...
public class PoliceBasic {
    ...
    private String poliOfficeName;
    
    private String poliRoleName;
    
    public String getPoliOfficeName() {
		return poliOfficeName;
	}

	public void setPoliOfficeName(String poliOfficeName) {
		this.poliOfficeName = poliOfficeName== null ? null : poliOfficeName.trim();
	}

	public String getPoliRoleName() {
		return poliRoleName;
	}

	public void setPoliRoleName(String poliRoleName) {
		this.poliRoleName = poliRoleName== null ? null : poliRoleName.trim();
	}
}