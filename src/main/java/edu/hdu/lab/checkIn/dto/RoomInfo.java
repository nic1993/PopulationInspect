...
public class RoomInfo {
	...
	private Boolean isOverInspect;

	public Boolean getIsOverInspect() {
		return isOverInspect;
	}

	public void setIsOverInspect(Boolean isOverInspect) {
		this.isOverInspect = isOverInspect;
	}
