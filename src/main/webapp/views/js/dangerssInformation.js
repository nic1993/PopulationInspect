function getDangerInformation(policeId,commId,buildId){
    var dataInforamtion = {};
    if(policeId != "" && policeId != undefined && policeId != null){
     ...
     dataInforamtion.pers_type = 1;
		...
		var informationCaption = $('#informationDangerCaption');
		var informationTittle = $('#informationDangerTittle');
	        ...
	        var informationThead = $('#informationDangerThead');
	        ...
	        var informationTbody = $('#informationDangerTbody');
	         ...
	         var body = "";
	          ...
	          //excel下载按钮
			var button = $("#informationDangerButton");
			    button.html("");
			    var buttonC = '';
			if(body != ""){
                buttonC += '<button class="btn btn-info" type="button" onclick="confirmdDangerInforExcel()">'+
                '导出详情到excel表</button>';
			}
...
function confirmdDangerInforExcel(){
...
function Dangerexcel(){
	var title = $("#informationDangerTittle").text();
      $("#informationDangertable").table2excel({
                  exclude: ".noExl",
