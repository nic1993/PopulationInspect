function getDangerInformation(policeId,commId,buildId){
    ...
    if(policeId != "" && policeId != undefined && policeId != null){
     ...
     dataInforamtion.pers_type = 1;
		...
		var informationCaption = $('#informationToxicCaption');
		var informationTittle = $('#informationToxicTittle');
	        ...
	        var informationThead = $('#informationToxicThead');
	        ...
	        var informationTbody = $('#informationToxicTbody');
	         ...
	         var body = "";
	          ...
	          //excel下载按钮
			var button = $("#informationToxicButton");
			    button.html("");
			    var buttonC = '';
			if(body != ""){
                buttonC += '<button class="btn btn-info" type="button" onclick="confirmdtoxicInforExcel()">'+
                '导出详情到excel表</button>';
			}
...
function confirmdtoxicInforExcel(){
