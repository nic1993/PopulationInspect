    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            templates: {
                ...
                filterClearBtn: '<span class="input-group-btn"><button class="btn btn-xs multiselect-clear-filter" type="button"><i class="glyphicon glyphicon-remove-circle"></i></button></span>',
